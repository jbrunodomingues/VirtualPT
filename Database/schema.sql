...
CREATE TABLE PERSONAL_TRAINER_CLIENT (
  ...
  CONSTRAINT FK_PERSONAL_TRAINER_CLIENT_1 FOREIGN KEY (REFID_PERSONAL_TRAINER) REFERENCES PERSONAL_TRAINER (ID_PERSONAL_TRAINER),
  CONSTRAINT FK_PERSONAL_TRAINER_CLIENT_2 FOREIGN KEY (REFID_CLIENT) REFERENCES CLIENT (ID_CLIENT)
)
  ENGINE = InnoDB;
